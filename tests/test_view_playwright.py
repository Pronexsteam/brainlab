...
def test_page_draws_graph_and_plays(srv):
    ...
    with playwright.sync_playwright() as p:
        ...
        # the canvas is not empty: there are pixels different from the background
        ...
        if runs:
            ...
            page.wait_for_function("document.getElementById('status').textContent.includes('run')", timeout=15000)
            page.click("#play")
